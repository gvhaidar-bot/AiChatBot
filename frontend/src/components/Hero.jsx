...
const Hero = () => {
  return (
    <>
      <section className="relative flex flex-col items-center text-white text-sm font-poppins overflow-hidden">
        <div className="relative z-10 flex flex-col items-center px-6 pt-32 pb-24 text-center">
          ...
          <h1 className="text-center text-4xl leading-[68px] md:text-5xl md:leading-[70px] mt-4 font-semibold max-w-2xl">Go Faster Then EveryOne</h1>

          <p className="text-center text-base max-w-lg mt-2 text-slate-300">Create Everyting With ChatBot Sendar</p>
