...
const Footer = () => {
  return (
    <footer className="w-full  bg-gradient-to-b border-t  bg-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col items-center">
        ...
        <div>
          <div className="flex items-center justify-center gap-4 mt-5 mb-5">
            ...
            <a className=" hover:-translate-y-0.5 duration-300 transition-all">
              <FaGithub className="text-white w-8 h-8 cursor-pointer" />
            </a>
            <a className=" hover:-translate-y-0.5 duration-300 transition-all">
              <FaWhatsapp className="text-white w-8 h-8 cursor-pointer" />
            </a>
            <a className=" hover:-translate-y-0.5 duration-300 transition-all">
